...
<div class="row">
        	<div class="col">
        		<div class="bg-light mt-3 px-2" style="border-radius: 5px; border: #000000 solid thick">
                        <h1>WHY JCU?</h1>
                        ...
                        <img height="100%" width="100%" src="images/art.jpg"/>
